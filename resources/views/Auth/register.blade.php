...
<head>
    <title>Activity Record Tracking System | Login</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('auth/images/3409297.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" method="POST">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter email">
                        <input class="input100" type="email" name="email" placeholder="User email" value="{{ old('email') }}">
                        <span class="focus-input100" data-placeholder="&#xe82a;"></span>
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
